...
exports.putMeAPI = exports.getMeAPI = exports.restoreUserAPI = exports.deleteUserAPI = exports.getUsersAPI = void 0;
const user_service_js_1 = require("../../services/user/user.service.js");
const UpdateUser_Schema_js_1 = require("../../model/Schema/User/UpdateUser_Schema.js");
/**
 * GET /admin/user
...
const getMeAPI = async (req, res) => {
    try {
        ...
        const me = await (0, user_service_js_1.getMeService)(+user.id);
        return res.status(200).json({
            status: 'success',
...
const putMeAPI = async (req, res) => {
    try {
        ...
        const parsed = await UpdateUser_Schema_js_1.UpdateUserSchema.safeParseAsync(req.body);
        if (!parsed.success) {
        ...
        const updated = await (0, user_service_js_1.updateMeService)(+user.id, parsed.data);
        return res.status(200).json({
            status: 'success',
