...
exports.RegisterDoctorSchema = void 0;
...
exports.RegisterDoctorSchema = zod_1.default
    .object({
    ...
    email: emailSchema,
    specialty_id: zod_1.default.number({ message: 'Chuyên khoa không hợp lệ hoặc bị trống' }).min(1, 'Chuyên khoa không được để trống'),
    price: zod_1.default.number({ message: 'Giá khám không hợp lệ hoặc bị trống' }).min(0, 'Giá khám không được để trống'),
